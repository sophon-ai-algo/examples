...
if __name__ == "__main__":
    ...
    parse.add_argument('--file_name',default="/workspace/test_sail/data/zhuheqiao.mp4",type=str,help="video name or image_path")
    ...
    parse.add_argument('--bmodel_path',default="/workspace/test/YOLOX/models/yolox_s_fp32_batch1/compilation.bmodel",type=str)
