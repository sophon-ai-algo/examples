/**
 * @brief Copied from examples/face_reconition/face_common.h
 * @date 12/28/2021
 */

#ifndef INFERENCE_FRAMEWORK_SAFEHAT_COMMON_H
#define INFERENCE_FRAMEWORK_SAFEHAT_COMMON_H
...
namespace bm {
    ...
    struct NetForward {
        ...
        std::vector<NetForward> subnet_ios;
        NetForward() {
            batch_size = 0;
        }
    };
...
#endif //INFERENCE_FRAMEWORK_SAFEHAT_COMMON_H
